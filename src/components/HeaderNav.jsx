...
export default function Header() {
    return (
        <AppBar position="static" sx={{ bgcolor: '#264653', marginTop: '10px', padding: '0', borderRadius: '20px', height: '50px'}}>
            <Container maxWidth='lg'>
                <Grid container spacing={2} sx={{
                    ...
                    <Grid size={3} sx={{
                        ...
                        sx={{ display: { xs: 'none', md: 'flex'}, fontWeight: 'bold', textDecoration: 'none', color: '#E9C46A'}}
                        >
                            aadak.dev
                        </LinkBase>
                        </Box>
